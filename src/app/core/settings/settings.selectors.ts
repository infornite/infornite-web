...
export const selectDiscoverFacetTab = createSelector(
  selectSettings,
  (settings) => settings.discoverFacetTab
);

export const selectDiscoverFilterPanel = createSelector(
  selectSettings,
  (settings) => settings.discoverFilterPanel
);