...
export const actionSettingsChangeDiscoverFacetTab = createAction(
  '[Settings] Change Discover Facet Tab',
  props<{ discoverFacetTab: boolean }>()
)

export const actionSettingsChangeDiscoverFilterPanel = createAction(
  '[Settings] Change Discover Filter Panel',
  props<{ discoverFilterPanel: boolean }>()
)